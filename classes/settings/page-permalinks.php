...
printf('<p>%s: <code style="white-space: nowrap;word-break: keep-all;word-wrap: normal;">wp transliterate permalinks</code></p>', esc_html__('For advanced users, this function can also be executed via WP-CLI using the command', 'serbian-transliteration'));

printf(
    '<p><strong class="text-danger">%s</strong></p>',
    wp_kses_post(sprintf(
        /* translators: %s: Link to the WordPress database backup documentation. */
        __('Important: Make sure to %s before running this script.', 'serbian-transliteration'),
